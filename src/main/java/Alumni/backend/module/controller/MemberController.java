...
public class MemberController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "검증되지 않은 이메일입니다", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "field가 존재하지 않습니다", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
